...
class CamelCardScorer(Day7lib):
    ...
    def main(self):
        ...
        self.populate_hand_details(content)

        for hand_type in sorted(self.hands.items()):
            hand_type[1].sort( key=functools.cmp_to_key(self.card_compare) )
...
if __name__ == "__main__":
    camel_card_scorer = CamelCardScorer()
    camel_card_scorer.run()
